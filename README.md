...
2. As a new user, I want the instructions to be easily found, clear and concise.
  - The rukes of Sudoku are clearly laid out on the instructions/rules page. 
...
- Hovering over the Navigation bar elements will trigger `hover` effect, highlighting the icon for the user.
...
- Show the win and lose messages when game ends.

![Game Over - Game Page](assets/testing-files/game-over.gif)
     
### Responsiveness
Manual testing was conducted on the all three site pages for responsiveness:

- Responsivensss of Home Page.

![Resposiveness - Home Page](assets/testing-files/responsive-home.gif)
     
- Responsivensss of Instructions/Rules Page.

![Resposiveness - Rules Page](assets/testing-files/responsive-rules.gif)

- Responsivensss of Game Page.
